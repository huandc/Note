...
public class Demo04 {
    public static void main(String[] args) throws IOException {
        // 2.1 转换输入流,指定utf8编码
        InputStreamReader isr = new InputStreamReader(new FileInputStream("in_utf.txt"), "utf-8");
        // 2.2 转换输出流,默认gbk编码
        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("out_gbk.txt"), "gbk");
...
public class Demo03 {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("Per_set.txt"));
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("Per_set.txt"));

        oos.writeObject(set);

        HashSet<Person> sets = (HashSet<Person>) ois.readObject();
