...
![demo01](java/images/1_cs.jpg)

**B/S结构*- ：全称为Browser/Server结构，是指浏览器和服务器结构。常见浏览器有谷歌、火狐等。

![](java/images/2_bs.jpg)
...
![UDP通信图解](java\images\UDP通信图解.bmp)
...
public static void main(String[] args) throws IOException {
        ...
        //**--回写数据--**
        OutputStream out = sever.getOutputStream();
        // 6. 回写数据
